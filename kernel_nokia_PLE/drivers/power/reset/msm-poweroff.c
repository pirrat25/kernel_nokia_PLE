...
#include "../../../drivers/fih/fih_rere.h"  /* to support fih reboot command */
...
static int __init oem_dload_set(char *str);//20151105,  ramdump set by fastboot 

module_param_call(download_mode, dload_set, param_get_int,
			&download_mode, 0644);
__setup("download_mode=", oem_dload_set);//20151105,  ramdump set by fastboot oem command			
...
//20151105,  ramdump set by fastboot oem command
